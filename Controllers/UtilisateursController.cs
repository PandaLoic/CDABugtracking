...
namespace Bugtracking.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Prenom,Email,Actif")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Prenom,Email,Actif")] Utilisateur utilisateur)
        {
